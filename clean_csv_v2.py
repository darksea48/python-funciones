...
input_file_path = r'C:\Users\Douglas Suárez Z\OneDrive - Cadem S.A\recovery 2022-08-05 trabajo cadem\estudios\2025-07-07 encuestas\19797 aiep\BASE_ AIEP Empleadores 2025 - SAE 19797 - WEB_PARTE2.csv'
#output_file_path = r'C:\Users\Douglas Suárez Z\OneDrive - Cadem S.A\recovery 2022-08-05 trabajo cadem\estudios\2025-07-07 encuestas\19797 aiep\BASE_ AIEP Empleadores 2025 - SAE 19797 - WEB_PARTE2_LIMPIO.csv'
output_file_path = r{input_file_path} + '_LIMPIO_v2.csv'
...
def clean_csv_data(input_path, output_path):
    ...
    try:
        ...
        print("Eliminando espacios de la celda...")
