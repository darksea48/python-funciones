...
ebano = Mascota("Ébano", 9, "Quiltro", "Macho", "Perro")
...
champinon = Mascota("Champiñon", "∞ (me encuentro en el corazón de mis amos)", "Tuxedo", "Macho")
...
time.sleep(2)
print()
tomate.onomatopeya().saludar()
kiki.onomatopeya().saludar()
cleo.onomatopeya().saludar()
oreo.onomatopeya().saludar()
print("-----------------------------------------")
print("Ahora pasarán las mascotas de los Jara Bugueño")
print()
time.sleep(2)
ebano.onomatopeya().saludar()
cinta.onomatopeya().saludar()
rebelde.onomatopeya().saludar()
tigrito.onomatopeya().saludar()
print("-----------------------------------------")
print("Y no me olvido de tí, pequeño amigo")
print()
time.sleep(1)
champinon.onomatopeya().saludar()
print("-----------------------------------------")
